...
import { ONE_BIPS, ZERO_PERCENT } from '../../constants/misc'
...
const PlusWrapper = styled.div<{ clickable: boolean }>`
  border-radius: 50%;
  height: 40px;
  width: 40px;
  position: relative;
...
const PoolInfoWrapper = styled.div`
  position:relative;
`
const PoolInfoContentWrapper= styled.div`
  border-radius: 5px;
  position: absolute;
  left: 150%;
  top:-50%;
...
export default function AddLiquidity({
  ...
  const [poolInfo, setTogglePoolInfo] = useState<boolean>(false)
        ...
        <Wrapper>
          ...
          <AutoColumn gap="20px">
            {noLiquidity ||
              (isCreate ? (
                ...
                <ColumnCenter>
                  <BlueCard>
                    <AutoColumn gap="10px">
                      <TYPE.link fontWeight={400} color={'#3354FF'}>
                        <Trans>
                          <b>
                            <Trans>Tip:</Trans>
                          </b>{' '}
            ...
            {currencies[Field.CURRENCY_A] && currencies[Field.CURRENCY_B] && pairState !== PairState.INVALID && (
              <>
                <LightCard padding="0px" backgroundColor={'#0C2345!important'} $borderRadius={'5px'}>
                  ...
                  <LightCard backgroundColor={'transparent!important'} padding="1rem" $borderRadius={'5px'}>
                    <PriceHeaderWrapper onClick={()=>setTogglePoolInfo(!poolInfo)}>
                      <Trans>Captured Screenshot</Trans>
                      {poolInfo && <PoolInfoWrapper>
                        <PoolInfoContentWrapper>
                          ...
                          <AutoColumn gap="8px">
                            <FixedHeightRow>
                              <RowFlat>    
                                <DoubleCurrencyLogo
                                  ...
                                  margin={true}
                                />
                                <Text fontSize={16} fontWeight={500} marginLeft={'3px'}>
                                  {currencies[Field.CURRENCY_A]?.symbol}/{currencies[Field.CURRENCY_B]?.symbol}
                                </Text>
                              </RowFlat>
                            ...
                            <FixedHeightRow>
                              <Text fontSize={16} fontWeight={500}>
                                <Trans>{currencies[Field.CURRENCY_A]?.symbol}:</Trans>
                              </Text>
                              <Text fontSize={16} fontWeight={500}>
                                {formattedAmounts[Field.CURRENCY_A]?formattedAmounts[Field.CURRENCY_A]:'-'}
                              </Text>
                            </FixedHeightRow>
                            <FixedHeightRow>
                              <RowFixed>
                                <Text fontSize={16} fontWeight={500}>
                                  <Trans>Pooled {currencies[Field.CURRENCY_B]?.symbol}:</Trans>
                                </Text>
                              </RowFixed>
                              
                              <RowFixed>
                                <Text fontSize={16} fontWeight={500} marginLeft={'6px'}>
                                  {formattedAmounts[Field.CURRENCY_B]?formattedAmounts[Field.CURRENCY_B]:'-'}
                                </Text>
