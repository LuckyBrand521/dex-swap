...
import CBSWAP_LIST from '../../constants/tokenLists/cbswap.tokenlist.json'
...
export function useCombinedActiveList(): TokenAddressMap {
  ...
  // get cbswap token list
  const cbswapTokens = useMemo(() => listToTokenMap(CBSWAP_LIST), [])
  return useMemo(() => combineMaps(activeTokens, combineMaps(cbswapTokens, TRANSFORMED_DEFAULT_TOKEN_LIST)), [activeTokens, cbswapTokens])
}
