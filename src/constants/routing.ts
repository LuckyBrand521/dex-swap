...
export const COMMON_BASES: ChainCurrencyList = {
  ...
  [SupportedChainId.BASE_GOERLI]: [
    ExtendedEther.onChain(SupportedChainId.BASE_GOERLI),
    WETH9_EXTENDED[SupportedChainId.BASE_GOERLI],
    USDC_BASE_GOERLI
  ],
}
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...WETH_ONLY,
  [SupportedChainId.MAINNET]: [...WETH_ONLY[SupportedChainId.MAINNET], DAI, USDC, USDT, WBTC],
  [SupportedChainId.BASE_GOERLI]: [...WETH_ONLY[SupportedChainId.BASE_GOERLI], USDC_BASE_GOERLI],
}
