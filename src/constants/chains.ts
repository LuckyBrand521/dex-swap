...
import baseGoerliLogoUrl from 'assets/svg/base_logo.svg'
...
export const CHAIN_INFO: ChainInfo = {
  ...
  [SupportedChainId.BASE_GOERLI]: {
    ...
    infoLink: 'https://info.uniswap.org/#/',
    label: 'Base Görli',
    logoUrl: baseGoerliLogoUrl,
    nativeCurrency: { name: 'Base GörliETH', symbol: 'ETH', decimals: 18 },
...
export const BASE_HELP_CENTER_LINK = 'https://docs.base.org/'
