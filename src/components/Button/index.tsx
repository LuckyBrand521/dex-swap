...
export const ButtonPrimary = styled(BaseButton)`
  ...
  &:disabled {
    background-color: ${({ theme, altDisabledStyle, disabled }) =>
      altDisabledStyle ? (disabled ? theme.primary1 : theme.bg13) : theme.bg13};
...
const ButtonErrorStyle = styled(BaseButton)`
  ...
  border: 1px solid ${({ theme }) => theme.bg13};
  box-shadow: inset 0px 0px 10px rgba(0, 0, 0, 0.25);
  &:focus {
    box-shadow: 0 0 0 1pt ${({ theme }) => darken(0.05, theme.bg13)};
    background-color: ${({ theme }) => darken(0.05, theme.bg13)};
  }
  &:hover {
    background-color: ${({ theme }) => darken(0.05, theme.bg13)};
  }
  &:active {
    box-shadow: 0 0 0 1pt ${({ theme }) => darken(0.1, theme.bg13)};
    background-color: ${({ theme }) => darken(0.1, theme.bg13)};
  }
  &:disabled {
    opacity: 50%;
    cursor: auto;
