              ...
              default:
                return (
                  <MenuFlyout>
                    ...
                    <MenuItem href="https://twitter.com/cbswapofficial">
                      <div>
                        <Trans>Twitter</Trans>
                      </div>
                      <TwitterIconMenu opacity={0.6} width={16} height={16} />
                    </MenuItem>
                    <MenuItem href="https://t.me/CBSWAPOFFICIAL">
                      <div>
                        <Trans>Telegram</Trans>
                      </div>
                      <TelegramIconMenu opacity={0.6} width={16} height={16} />
                    </MenuItem>
                    <MenuItem href="https://medium.com/@CBSWAPOFFICIAL">
                      <div>
                        <Trans>Medium</Trans>
                      </div>
                      <MediumIconMenu opacity={0.6} width={16} height={16} />
                    </MenuItem>
                    <MenuItem href="https://github.com/cbswapio">
                      <div>
                        <Trans>Github</Trans>
                      </div>
                      <GithubIconMenu opacity={0.6} width={16} height={16} />
                    </MenuItem>
                    ...
                    <MenuItem href="https://docs.base.org/">
                      <div>
                        <Trans>Docs</Trans>
                      </div>
