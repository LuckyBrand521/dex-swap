...
const CurrencySelect = styled(ButtonGray)<{ visible: boolean; selected: boolean; hideInput?: boolean }>`
  ...
  font-size: 15px;
  font-weight: 300;
  background-color: ${({ selected, theme }) => (selected ? theme.bg0 : theme.primary6)};
  ...
  :focus,
  :hover {
    background-color: ${({ selected, theme }) => (selected ? darken(0.05, theme.bg0) : darken(0.05, theme.primary6))};
  }
`
