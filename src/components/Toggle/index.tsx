...
const ToggleElement = styled.span<{ isActive?: boolean; isOnSwitch?: boolean }>`
  ...
  border-radius: 9px;
  background: ${({ theme, isActive, isOnSwitch }) => (isActive ? (isOnSwitch ? theme.primary6 : theme.bg4) : 'none')};
  ...
  :hover {
    ...
    background: ${({ theme, isActive, isOnSwitch }) =>
      isActive ? (isOnSwitch ? darken(0.05, theme.primary6) : darken(0.05, theme.bg4)) : 'none'};
